 ...
 * 
 * This file contains all the code changes needed to replace the bird from the original "Fly By" game with the DJI FPV drone.
...
const setCharacter = async () => {
  ...
  // The DJI FPV drone model might need different scaling
  character.scale.set(0.05, 0.05, 0.05); // Adjust these values as needed
  
  // Rotate the drone to face forward if needed
  ...
  // Use dynamic import for the animation module
